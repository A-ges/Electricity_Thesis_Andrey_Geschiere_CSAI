...
Expected more from the tipping population, needs a good group of price sensitive to make a change. Epsilon/Appliance shift rates discutable, same as the calibration of the baseline curve. Why did I keep behavioral parameters the same. Every day had the same solar, perhaps a new simulation could draw over a period with all real weather conditions
