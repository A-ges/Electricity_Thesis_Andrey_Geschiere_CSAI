...
A study by Yilmaz et al. (2017) delivered hourly switch-on probabilities, which in turn was derived from a 2011 survey on UK appliance usage (Department of Energy \& Climate Change, 2014). While dated, the dataset’s high granularity and veracity make it a solid foundation for modern studies when calibrated to reflect current energy trends (Yilmaz et al. 2017; Williams et al., 2025). 
