...
As it is common with ABM, certain limitations because of the estimations. 
Expected more from the tipping population, needs a good group of price sensitive to make a change. Epsilon/Appliance shift rates discussable, same as the calibration procedure of the baseline curve. Keeping behavioral parameters the same is discussable. Every day had the same solar, perhaps a new simulation could draw over a period with all real weather conditions. Include batteries for agents' own solar storage. More research needed to set the good hyperparameters. Give agents an innovation degree.   
