...
Price responsiveness functions as the behavioral counterpart: the agent who actively shifts consumption toward cheaper periods in response to market signals. \textcite{haseler_promoting_2024} characterize this profile, mentioning that "a household's financial savings potential depends on its responsiveness: the size of the loads to be shifted, by how long they can be shifted, and the consumer's proficiency at scheduling consumption based on the price profile."
