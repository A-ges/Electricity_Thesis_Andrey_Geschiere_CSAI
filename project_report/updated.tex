...
\begin{figure}[p] % [p] gives it a dedicated page for maximum size
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.15\textwidth]{images/simulation_pipeline.png}
    }
